...
public class Constants {
    ...
    public static final String DEFAULT_DUBBO_PROPERTIES = "mydubbo.properties";
    ...
    public static final String DEFAULT_DIRECTORY = "mydubbo";

    public static final String DEFAULT_LOADBALANCE = "random";

    public static final String DEFAULT_PROTOCOL = "mydubbo";
    ...
    public static final String DEFAULT_REMOTING_CODEC = "mydubbo";
...
//    public static final int DEFAULT_REGISTRY_CONNECT_TIMEOUT = 5000;
    ...
    public static final String DEFAULT_REGISTRY = "mydubbo";
    ...
    public static final String DEFAULT_PROMPT = "mydubbo>";
    ...
    public static final String DUBBO_VERSION_KEY = "mydubbo";
    ...
    @Deprecated
    public static final String SHUTDOWN_WAIT_SECONDS_KEY = "mydubbo.service.shutdown.wait.seconds";
    ...
    public static final String STUB_EVENT_KEY = "mydubbo.stub.event";

    public static final boolean DEFAULT_STUB_EVENT = false;

    public static final String STUB_EVENT_METHODS_KEY = "mydubbo.stub.event.methods";
    ...
    public static final String DUBBO_IP_TO_REGISTRY = "MYDUBBO_IP_TO_REGISTRY";

    public static final String DUBBO_PORT_TO_REGISTRY = "MYDUBBO_PORT_TO_REGISTRY";

    public static final String DUBBO_IP_TO_BIND = "MYDUBBO_IP_TO_BIND";

    public static final String DUBBO_PORT_TO_BIND = "MYDUBBO_PORT_TO_BIND";
